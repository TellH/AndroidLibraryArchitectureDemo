...
public class TestDaoGenerator {
    public static void main(String[] args) throws Exception{
        ...
        // 创建数据库
        Schema schema = new Schema(1,"com.tellh.greendao");
//        当然，如果你愿意，你也可以分别指定生成的 Bean 与 DAO 类所在的目录，只要如下所示：
//      Schema schema = new Schema(1, "com.tellh.bean");
//      schema.setDefaultJavaPackageDao("com.tellh.dao");
    ...
    private static void generateDaoFiles(Schema schema) throws Exception {
        new DaoGenerator().generateAll(schema, "../AndroidLibraryArchitectureDemo/app/src/main/java-greendao");
    }
